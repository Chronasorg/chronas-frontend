...
export interface SpinnerGlobalProps {
...
/**
 * SpinnerGlobal component - Full-screen loading spinner with Chronas logo.
 * Features a rotating logo SVG with 1-second animation and blinking text.
 * Theme-aware using CSS custom properties.
 */
export const SpinnerGlobal: React.FC<SpinnerGlobalProps> = ({
  title = 'loading...',
  className,
}) => {
    ...
    <div className={classNames}>
      <div className={styles['inner']}>
        <svg
          ...
          width="40%"
          height="40%"
          viewBox="0 0 4220 4220"
          preserveAspectRatio="xMidYMid meet"
          aria-hidden="true"
        >
          <g className={styles['logoCircle']} stroke="none">
